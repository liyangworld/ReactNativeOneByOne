...
class OUIViewPage extends Component {
        ...
        return(
            <View style={{flex:1}}>
                ...
                <View style={[styles.layoutWrap]}>
                    <View style={[styles.item,{backgroundColor:'#f00',}]}></View>
                    <View style={[styles.item,{backgroundColor:'#0f0',}]}></View>
                    <View style={[styles.item,{backgroundColor:'#00f',}]}></View>
                </View>
